...
# -*- coding: utf-8 -*-
#
# ndx-task documentation build configuration file, created by
# sphinx-quickstart on Fri Jun 21 16:46:49 2019.
#
...
latex_documents = [
    (master_doc, 'ndx-task.tex', 'ndx-task Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-task', 'ndx-task Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-task', 'ndx-task Documentation',
     author, 'ndx-task', 'One line description of project.',
     'Miscellaneous'),
]

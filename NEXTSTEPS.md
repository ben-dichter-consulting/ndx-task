# Next Steps for ndx-task Extension for NWB:N

## Creating Your Extension

1. In a terminal, change directory into the new ndx-task directory.
...
4. Modify `src/create_extension_spec.py` to define your extension.
    ...
    - If you want to create any custom classes for interacting with the extension,
      ...
      - If present, the `src/pynwb` folder MUST contain the following:
        - `ndx-task` - Folder with the sources of the NWB extension
        - `ndx-task/__init__.py` - Python file that may be empty
...
`spec/ndx-task.namespace.yaml` and
`spec/ndx-task.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-task
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/bendichter/ndx-task/releases/tag/0.1.0

9. Publish your updated extension on PyPi.
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-task/0.1.0
...
`staged-extensions/ndx-task`:

    ```bash
cp -r staged-extensions/example staged-extensions/ndx-task
```

11. Edit `staged-extensions/ndx-task/ndx-meta.yaml`
...
name: ndx-task
version: 0.1.0
src: https://github.com/bendichter/ndx-task
pip: https://pypi.org/project/ndx-task/
license: BSD 3-Clause
maintainers:
  - bendichter
```

12. Edit `staged-extensions/ndx-task/README.md`
to add information about your extension. You may copy it from
`ndx-task/README.md`.

  ```bash
cp ndx-task/README.md staged-extensions/ndx-task/README.md
```
...
ndx-task-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-task GitHub repository.

2. Publish your updated extension on PyPi.

3. Fork the ndx-task-feedstock repository on GitHub.
